...
RENDERING_EXPORT (focused、Phase B で実装):
  9. docs/capability-bom-sample/rendering-export/10-requirements.md
 10. docs/capability-bom-sample/rendering-export/20-capability-bom.md
 11. docs/capability-bom-sample/rendering-export/21-rendering-export.yaml
 12. docs/capability-bom-sample/rendering-export/30-design.md
...
- 評価記録: `90-feasibility-notes.md` Addendum H
