...
| 方法論本体への昇格 | 11-14/21/22 を OneDrive 01-10 へ | baseline 固定後 (本台帳 + 契約 v1.0 が前提) |
...
- 機械照合: `../methodology-extensions/22-bom-conformance-check.md` + `../../experiments/bom-conformance-check/`
- 方法論拡張: `../methodology-extensions/` (11〜14 / 21 / 22)
