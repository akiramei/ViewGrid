...
| 配置 | サンプル成果物の **上位** (`docs/capability-bom-audit/samples/00-convention-contract.md` 等、1 ファイル) |
...
> 詳細は `docs/capability-bom-audit/samples/00-convention-contract.md §1.8` と Addendum G / H。
...
- 実証根拠 (必要性): `docs/capability-bom-audit/evaluation/90-feasibility-notes.md` Addendum E
...
- 具体契約インスタンス: `docs/capability-bom-audit/samples/00-convention-contract.md` (v0.3、§1.8 C-CONSUMER-PORTS 前倒し + §1.9 C-IDENTITY-BOUNDARY)
- 同時生成プロンプト: `docs/capability-bom-audit/samples/prompts/` (41 n=2 / 42 n=3 後付け / 43 n=2 前倒し再生成→n=3)
- RENDERING サンプル: `docs/capability-bom-audit/samples/rendering-export/`
