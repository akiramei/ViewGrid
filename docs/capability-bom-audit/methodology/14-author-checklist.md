...
- 実証根拠: `docs/capability-bom-audit/evaluation/90-feasibility-notes.md` Addendum A / B / C / D
- 実例: `docs/capability-bom-audit/samples/` (GRID v0.2) と `docs/capability-bom-audit/samples/image-variant-management/` (IMAGE_VARIANT v0.1)
