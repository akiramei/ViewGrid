...
Three check categories (see docs/capability-bom-audit/methodology/22-bom-conformance-check.md):
...
Run:  python docs/capability-bom-audit/tools/bom-conformance-check/checker.py
"""
...
# checker.py lives at docs/capability-bom-audit/tools/bom-conformance-check/ ->
# repo root is 4 levels up.
ROOT = Path(__file__).resolve().parents[4]
SAMPLE = ROOT / "docs" / "capability-bom-audit" / "samples"
...
BOMS = {
    "GRID_COMPOSITION": SAMPLE / "grid-composition" / "21-grid-composition.yaml",
