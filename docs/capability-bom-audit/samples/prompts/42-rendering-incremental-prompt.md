...
横断契約 (v0.2、最優先・変更不可):
  0. docs/capability-bom-audit/samples/00-convention-contract.md   (特に §1.8 C-CONSUMER-PORTS)
追加する Capability (RENDERING_EXPORT, focused):
  1. docs/capability-bom-audit/samples/rendering-export/10-requirements.md
  2. docs/capability-bom-audit/samples/rendering-export/20-capability-bom.md
  3. docs/capability-bom-audit/samples/rendering-export/21-rendering-export.yaml
  4. docs/capability-bom-audit/samples/rendering-export/30-design.md
...
- 評価記録: `../../evaluation/90-feasibility-notes.md` Addendum G
