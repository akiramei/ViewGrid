...
1. docs/capability-bom-audit/samples/image-variant-management/10-requirements.md
2. docs/capability-bom-audit/samples/image-variant-management/20-capability-bom.md
3. docs/capability-bom-audit/samples/image-variant-management/21-image-variant-management.yaml
4. docs/capability-bom-audit/samples/image-variant-management/30-design.md

参考 (隣接 Capability の境界条件、必要に応じて):
- docs/capability-bom-audit/samples/grid-composition/20-capability-bom.md (GRID_COMPOSITION)
- docs/capability-bom-audit/samples/grid-composition/21-grid-composition.yaml
...
- `../../methodology/09-ai-audit-prompt-guide.md` — プロンプト設計原典
- `10/20/21/30-*.md` — 本プロンプトの入力
- `../40-ai-implementation-prompt.md` — GRID_COMPOSITION 側 (規範比較)
- `../../evaluation/90-feasibility-notes.md` Addendum C — 境界調整負荷の評価
