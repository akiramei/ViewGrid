...
- 実証根拠: `docs/capability-bom-sample/90-feasibility-notes.md` Addendum B §B.5, Addendum D §D.4
- サンプル実例: `docs/capability-bom-sample/30-design.md` §1 R-02 NOTE / §2.2 UC-07 / §7 W-3 / §8 AT-03
